...
const Features = () => {
  ...
  return (
    ...
    >
      <div class="flex items-center gap-2 text-sm text-indigo-600  bg-indigo-300 rounded-full px-6 py-1.5">
       <Zap width={14} />
        <span>Simple Process</span>
      </div>

      <Title
        title="당신의 이력서를 만들어보세요"
        description="우리의 간단한 AI 생성 과정을 통해 쉽고 빠르게 전문적인 이력서를 빠르게 생성할 수 있습니다."
      />
